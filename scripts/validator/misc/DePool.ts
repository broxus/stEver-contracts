export const DE_POOL_ABI = {
  ...
  functions: [
    ...
    },
    {
      ...
      inputs: [{ name: "_allowedParticipant", type: "address" }],
      outputs: [],
    },
    {
    ...
    },
    {
      ...
      inputs: [{ name: "withdrawValue", type: "uint64" }],
      outputs: [],
    },
    {
    ...
    },
    {
      ...
      inputs: [{ name: "fraction", type: "uint8" }],
      outputs: [],
    },
    {
      name: "receiveFunds",
    ...
    },
    {
      ...
      inputs: [],
      outputs: [{ name: "value0", type: "int256" }],
    },
    {
      name: "getRounds",
      inputs: [],
    ...
    },
    {
      ...
      inputs: [],
      outputs: [{ name: "allowedParticipants", type: "map(address,bool)" }],
    },
  ],
  data: [],
  events: [
    ...
    },
    {
      ...
      inputs: [{ name: "replenishment", type: "uint256" }],
      outputs: [],
    },
    {
  ...
  fields: [
    ...
    },
    {
      components: [
        ...
        { name: "unfreeze", type: "uint32" },
        { name: "stakeHeldFor", type: "uint32" },
        { name: "validatorsElectedFor", type: "uint32" },
        { name: "vsetHashInElectionPhase", type: "uint256" },
        { name: "step", type: "uint8" },
        { name: "completionReason", type: "uint8" },
        { name: "stake", type: "uint64" },
        ...
        { name: "unused", type: "uint64" },
        { name: "isValidatorStakeCompleted", type: "bool" },
        { name: "grossReward", type: "uint64" },
        { name: "participantReward", type: "uint64" },
        { name: "validatorReward", type: "uint64" },
        { name: "participantQty", type: "uint32" },
        {
          components: [
            { name: "ordinary", type: "uint64" },
            {
              components: [
                { name: "remainingAmount", type: "uint64" },
                { name: "lastWithdrawalTime", type: "uint64" },
